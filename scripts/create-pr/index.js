...
(async () => {
    try {
        const createPullRequestResult = await octokit.rest.pulls.create({
            ...
            body: `Generated by https://github.com/w3c/aria-practices/commit/${process.env.APG_SHA}.`,
        ...
        let previewLinkUrl = `https://deploy-preview-${createPullRequestResult.data.number}--wai-aria-practices.netlify.app`;
