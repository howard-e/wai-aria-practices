...
<div>
  ...
  <p>
    ...
    <a href="/patterns/grid/">grid design pattern</a>
  ...
  <section>
    ...
    <dl>
      ...
      <dd>
        ...
        <a href="/patterns/grid/#gridNav">Setting Focus and Navigating Inside Cells</a>
      ...
      <tbody>
        <tr data-test-id="grid-role">
          ...
          <td>
            ...
            Because focus is managed using <a href="/fundamentals/keyboard-interface/#kbd_roving_tabindex">roving tabindex</a>, the grid element is not focusable.
          </td>
        </tr>
